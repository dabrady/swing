...
class PFrame extends JFrame{
  ...
  public static HomeScreen2 home;  //since there can only be one instance of PFrame, I thought it fitting (though redundant) to make its fields static (shared among all instances)
  public static OverWorld2 ow;
  public static BattleScreen2 battle;
   
  private PFrame(String title){
    super(title);
	home = new HomeScreen2(this, "homescreen.png");
	ow = new OverWorld2(this, "overworld.png");
	battle = new BattleScreen2(this, "battlescreen.png");
	ow.setVisible(false);
...
class HomeScreen2 extends ImagePanel2 implements ActionListener{
  public PFrame parent;
  public JPanel contentPane;
  
  public HomeScreen2(PFrame parent, String url){
    super(url);
	this.parent = parent;
...
class OverWorld2 extends ImagePanel2 implements ActionListener{
  public PFrame parent;
  public JPanel contentPane;
  
  public OverWorld2(PFrame parent, String url){
    super(url);
	this.parent = parent;
	this.setLayout(new BorderLayout());
    this.setPreferredSize(new Dimension(719, 476));	
...
class BattleScreen2 extends ImagePanel2 implements ActionListener{
  public PFrame parent;
  public JPanel contentPane;
  
  public BattleScreen2(PFrame parent, String url){
    super(url);
	this.parent = parent;
	this.setLayout(new BorderLayout());
    this.setPreferredSize(new Dimension(719, 476));	
